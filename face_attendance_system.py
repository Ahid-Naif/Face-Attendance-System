...
import xlrd # Excel
from datetime import date # Date & time from operating system
from datetime import datetime # Date & time from operating system
...
if __name__ == "__main__":
    entrance_camera = cv2.VideoCapture(1) # 1 -> port number
    exit_camera = cv2.VideoCapture(2) # 2 -> port number
