...
button_pin = 17
known_face_pin = 27  # GPIO pin for known face (HIGH)
unknown_face_pin = 22  # GPIO pin for unknown face (HIGH)
GPIO.setup(button_pin, GPIO.IN, pull_up_down=GPIO.PUD_UP)
GPIO.setup(known_face_pin, GPIO.OUT, initial=GPIO.LOW)
GPIO.setup(unknown_face_pin, GPIO.OUT, initial=GPIO.LOW)
    ...
    if GPIO.input(button_pin) == GPIO.LOW:  # Button is pressed
        ...
        for face_encoding in face_encodings:
            ...
            for (top, right, bottom, left), name in zip(face_locations, face_names):
                ...
                if name == 'Unknown':
                    GPIO.output(unknown_face_pin, GPIO.HIGH)
                    time.sleep(0.5)
                    GPIO.output(unknown_face_pin, GPIO.LOW)
                    ...
                    GPIO.output(known_face_pin, GPIO.HIGH)
                    time.sleep(0.5)
                    GPIO.output(known_face_pin, GPIO.LOW)
